...
simulation_habitat_randomization <- function(number_coloumns, number_rows, 
  ...
  for(i in 1: length(alpha_sequence)){
    ...
    for(j in 1:simulation_runs){
      ...
      detections_tibble[nrow(detections_tibble)+1,] <- c(Correct=sum(result[[1]]$Significance[result[[1]]$Habitat==habitat_1] == "Positive", na.rm=T),
      ...
      detections_tibble[nrow(detections_tibble)+1,] <- c(Correct=sum(result[[2]]$Significance[result[[2]]$Habitat==habitat_2] == "Positive", na.rm=T),
      ...
      detections_tibble[nrow(detections_tibble)+1,] <- c(Correct=sum(result[[3]]$Significance[result[[3]]$Habitat==habitat_3] == "Negative", na.rm=T),
      ...
      detections_tibble[nrow(detections_tibble)+1,] <- c(Correct=sum(result[[4]]$Significance[result[[4]]$Habitat==habitat_4] == "Negative", na.rm=T),
...
simulation_point_process <- function(number_coloumns, number_rows, 
  ...
  for(i in 1:length(alpha_sequence)){
    ...
    for(j in 1:simulation_runs){
      ...
      detections_tibble[nrow(detections_tibble)+1,] <- c(Correct=sum(result_species_1$Significance[result_species_1$Habitat==habitat_1] == "Positive", na.rm=T),
      ...
      detections_tibble[nrow(detections_tibble)+1,] <- c(Correct=sum(result_species_2$Significance[result_species_2$Habitat==habitat_2] == "Positive", na.rm=T),
      ...
      detections_tibble[nrow(detections_tibble)+1,] <- c(Correct=sum(result_species_3$Significance[result_species_3$Habitat==habitat_3] == "Negative", na.rm=T),
      ...
      detections_tibble[nrow(detections_tibble)+1,] <- c(Correct=sum(result_species_4$Significance[result_species_4$Habitat==habitat_4] == "Negative", na.rm=T),
...
simulation_study_habitat_randomization_association <- simulation_habitat_randomization(number_coloumns=number_coloumns, 
...
# Save.Function.rds(object=simulation_study_habitat_randomization_association, 
#                   file=paste0(results,"/simulation_study_habitat_randomization_association.rds"))


# Torus translation (Harms et al. 2001) #
simulation_study_torus_translation_association <- simulation_torus_translation(number_coloumns=number_coloumns, 
                                                                   number_rows=number_rows, 
                                                                   roughness=roughness,
                                                                   resolution=resolution, 
                                                                   number_points=number_points,
...
# Save.Function.rds(object=simulation_study_torus_translation_association, 
#                   file=paste0(results,"/simulation_study_torus_translation_association.rds"))


# Fitting point process (Plotkin et al. 2000) #
simulation_study_point_process_association <- simulation_point_process(number_coloumns=number_coloumns, 
                                                           number_rows=number_rows, 
                                                           roughness=roughness,
                                                           resolution=resolution,
                                                           ...
                                                           alpha_sequence=alpha_sequence, 
                                                           simulation_runs=simulation_runs)
# Save.Function.rds(object=simulation_study_point_process_association, 
#                   file=paste0(results,"/simulation_study_point_process_association.rds"))
