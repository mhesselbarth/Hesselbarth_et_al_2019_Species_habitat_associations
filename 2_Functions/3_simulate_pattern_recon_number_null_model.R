simulate_pattern_recon_number_null_model <- function(number_coloumns, number_rows,
  ...
  result <- furrr::future_map_dfr(number_pattern , function(number_current){
    ...
    furrr::future_map_dfr(1:simulation_runs, function(simulation_run_current){
      ...
      detection_spec_1 <- simulation_pattern %>%
        ...
        SHAR::reconstruct_pattern(number_reconstructions = number_current, 
