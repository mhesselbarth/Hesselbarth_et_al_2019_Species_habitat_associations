...
Create.Simulation.Pattern <- function(raster, number_points=100, alpha=0.3){
  ...
  species_1 <- Create.Simulation.Species(raster=raster, type="positive", process="Poisson",
  ...
  species_2 <- Create.Simulation.Species(raster=raster, type="positive", process="Thomas",
  ...
  species_3 <- Create.Simulation.Species(raster=raster, type="negative", process="Poisson",
  ...
  species_4 <- Create.Simulation.Species(raster=raster, type="negative", process="Thomas",
