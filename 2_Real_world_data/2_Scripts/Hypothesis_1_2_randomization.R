...
reconstructed_beech <- clustermq::Q(fun = shar::reconstruct_pattern_cluster,
...
reconstructed_ash <- clustermq::Q(fun = reconstruct_pattern_cluster,
                                  n_random = n_random_hpc,
...
reconstructed_hornbeam <- clustermq::Q(fun = shar::reconstruct_pattern_cluster,
                                       n_random = n_random_hpc,
...
reconstructed_sycamore <- clustermq::Q(fun = shar::reconstruct_pattern_cluster,
                                       n_random = n_random_hpc,
...
reconstructed_others <- clustermq::Q(fun = shar::reconstruct_pattern_cluster,
                                     n_random = n_random_hpc,
