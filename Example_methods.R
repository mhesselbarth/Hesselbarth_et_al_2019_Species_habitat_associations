...
plot_landscape_overall <- gridExtra::grid.arrange(plot_landscape_original, 
                                                  plot_landscape_classified, 
                                                  ncol=2)
Save.Function.ggplot(object=plot_landscape_overall, file=paste0(figures, "/Habitat_classification.jpeg"), dpi=1000)
...
Save.Function.ggplot(object=plot_overall_point_process, file=paste0(figures, "/Gamma_test.jpeg"), dpi=1000)
...
Save.Function.ggplot(object=plot_overall_habitat_randomization, file=paste0(figures, "/Habitat_randomization.jpeg"), dpi=1000)
...
Save.Function.ggplot(object=plot_overall_torus_translation, file=paste0(figures, "/Torus_translation.jpeg"), dpi=1000)
